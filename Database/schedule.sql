...
ALTER TABLE `BLOCK_TO_ROOM` ADD FOREIGN KEY (`BlockId`) REFERENCES `BLOCK` (`Id`);

ALTER TABLE `BLOCK_TO_ROOM` ADD FOREIGN KEY (`RoomId`) REFERENCES `ROOM` (`Id`);
